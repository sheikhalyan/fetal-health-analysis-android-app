...
public class VolusionS8 extends AppCompatActivity {
    ...
    private static final String TAG = "VolusionS8";

    String imageUrl = "http://192.168.0.107:5000/get_image?filename=voluson_s8_plot.png";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_volusion_s8);
