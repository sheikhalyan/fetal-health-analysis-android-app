...
public class VolusionS10 extends AppCompatActivity {
    ...
    Uri selectedImage;
    String imageUrl = "http://192.168.0.107:5000/get_image?filename=voluson_s10_plot.png";
    private static final String TAG = "VolusionS10";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_volusion_s10);
