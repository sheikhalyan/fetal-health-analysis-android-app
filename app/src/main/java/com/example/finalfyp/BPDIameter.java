...
public class BPDIameter extends AppCompatActivity {
    TextView textView;
    ImageView imageView;
    Button btnSshowImage, btnUuploadImage;
    TextView getnamee;
    TextView majorAxisTextView;
    TextView minorAxisTextView;
    TextView estimatedLengthTextView;
    Uri selectedImage;
    SessionManager sessionManager;
    LinearLayout btnBpd;
    String imageUrl = "http://192.168.0.107:5000/get_image?filename=BPD_plot.png";

    private static final String TAG = "BPDIameter";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bpdiameter);
        sessionManager = new SessionManager(getApplicationContext());
        getnamee = findViewById(R.id.getnamee);
        String username = getIntent().getStringExtra("name");
        getnamee.setText(username);
