...
public class VolusionE6 extends AppCompatActivity {
    ...
    private static final String TAG = "VolusionE6";

    String imageUrl = "http://192.168.0.107:5000/get_image?filename=voluson_e6_plot.png";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_volusion_e6);
